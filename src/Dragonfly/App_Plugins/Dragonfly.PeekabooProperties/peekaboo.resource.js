//angular.module('umbraco.resources').factory('Dragonfly.PeekabooPropertiesResource', function ($q, $http) {
//    return {

//        getSqlListItems: function (sqlCommand, keyColumnName, textColumnName, tabsColumnName, propertiesColumnName, cacheDuration) {
//            return $http.get("backoffice/Dragonfly.PeekabooProperties/Dragonfly.PeekabooPropertiesApi/GetSqlListItems", {
//                cache: true,
